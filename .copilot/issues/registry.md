...
| [ISS-CI-001](ISS-CI-001.md) | blocker | ci/infrastructure | Pre-existing CI failures (arch-check 25 violations, biome 20,432 errors, pnpm audit 2 high CVEs) block all future PRs to main | open | _(to be spawned — `wf-20260624-fix-20`)_ | 2026-06-24 |
