...
**Scope.** Modify `infrastructure/restic/aiqadam-backup.sh` (or wherever the daily backup script lives — see `docs/runbooks/restic-backups.md`) to add a pre-backup hook:
...
`docs/runbooks/snapshot-restore.md` — covering:
