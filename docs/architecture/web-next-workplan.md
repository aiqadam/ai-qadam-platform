...
> phase plan), [`blocks.md`](./blocks.md) (catalogue),
> [`wiring-map.md`](./wiring-map.md), and [`parity-matrix.md`](./parity-matrix.md)
...
- Every block add/edit updates [`blocks.md`](./blocks.md) in the SAME PR
  (enforced by `architecture-check`).
- Every new data wiring updates [`wiring-map.md`](./wiring-map.md).
