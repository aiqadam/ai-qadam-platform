...
7. **Walk-through (engineer-side).** Per [`docs/runbooks/country-lead-activation.md`](../runbooks/country-lead-activation.md): RBAC binding, cabinet walk-through, permission verification.
...
| KZ | TBD — gated on G-1 | TBD | Candidate identification in progress per [`docs/community-platform-roadmap.md` §11](../community-platform-roadmap.md) |
...
- [`docs/business-process-gaps.md`](../business-process-gaps.md) G-1 — the trigger conditions for revisit
- [`docs/runbooks/country-lead-activation.md`](../runbooks/country-lead-activation.md) — the engineer-side counterpart
