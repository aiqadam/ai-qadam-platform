...
- [`country-launch.md`](./country-launch.md) — trust-transfer ceremony, AUP, first-event setup (pairs with [`country-lead-activation.md`](../runbooks/country-lead-activation.md) on the engineer side)
...
- [`docs/marketing-and-pr-playbook.md`](../marketing-and-pr-playbook.md) — the strategy layer; operators read this to understand WHY each workflow exists
- [`docs/ux-and-content-guidelines.md`](../ux-and-content-guidelines.md) §1 — voice + tone for every operator-authored string
