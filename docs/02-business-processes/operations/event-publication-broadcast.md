...
**Pre-reading:** [ADR-0033](../../adr/0033-community-member-graph.md), [ux-and-content-guidelines.md §13](../../04-development/design-system/ux-and-content-guidelines.md#13-notification-copy-library), [interaction-architecture.md](../../04-development/architecture/interaction-architecture.md), [operator-event-control.md](operator-event-control.md).
**Ships:** F-S1.1a.
