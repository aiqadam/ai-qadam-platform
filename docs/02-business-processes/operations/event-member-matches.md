...
**Pre-reading:** [event-pre-event-reminders.md](event-pre-event-reminders.md), [member-profile.md](member-profile.md), [interaction-architecture.md](../../04-development/architecture/interaction-architecture.md), [ux-and-content-guidelines.md §13](../../04-development/design-system/ux-and-content-guidelines.md#13-notification-copy-library).
**Ships:** F-S1.5.
