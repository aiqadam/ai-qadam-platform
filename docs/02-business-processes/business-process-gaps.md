...
>
> **Owner.** PM reviews this list at the same weekly cadence as the decision-batch ([decision-batch-process.md](decision-batch-process.md)).
...
3. If the gap blocks a sprint or feature, update that sprint's row in [`community-platform-roadmap.md` §7](../01-business/community-platform-roadmap.md) + the open-decisions list in §10 to reference the gap.
