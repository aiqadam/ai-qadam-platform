...
| [BP-UAT-009](BP-UAT-009.md) | Auth sign-in and sign-out | Implemented | 2026-08-01 | pass (targeted: AC-1/AC-2/AC-3 password regression + FR-AUTH-004 entry-point check, wf-20260801-uat-180) | [BP-UAT-009.spec.ts](../../../../apps/e2e/tests/uat/BP-UAT-009.spec.ts) | <br>smoke-auth-gates.spec.ts<br>smoke-me-profile.spec.ts<br>smoke-workspace-members.spec.ts |
...
| [BP-UAT-013](BP-UAT-013.md) | Member signup and operator onboarding | Implemented | 2026-07-06 | partial (5/7 ACs verified; AC-1 email+AC-2 blocked by RESEND_API_KEY env) | [BP-UAT-013-signup.spec.ts](../../../../apps/e2e/tests/uat/BP-UAT-013-signup.spec.ts) | <br>smoke-lead-nurture.spec.ts<br>smoke-leads.spec.ts<br>smoke-onboarding.spec.ts<br>+1 more |
...
| [BP-UAT-020](BP-UAT-020.md) | Platform admin bootstrap (no manual scripts) | Implemented | 2026-07-29 | partial (AC-1/AC-2/AC-4/AC-5 verified MATCH; AC-3 verified MISMATCH — ISS-ADM-010-1) | [BP-UAT-020.session.spec.ts](../../../../apps/e2e/tests/uat/BP-UAT-020.session.spec.ts) | — |
