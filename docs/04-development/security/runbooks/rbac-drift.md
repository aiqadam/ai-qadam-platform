...
**Pre-reading:** [ADR-0021](../../../adr/0021-rbac-manifest.md) (the canonical manifest), [`docs/01-business/community-platform-roadmap.md` §7 Sprint 2.2](../../../01-business/community-platform-roadmap.md) (the sync service that's supposed to prevent drift), [`auth.md`](../../infrastructure/runbooks/auth.md) §C (RBAC sync failure case).

**Total time:** 10–30 min per drift instance.

> **Scaffold** — full procedure lands with F-S2.2 RBAC sync + the nightly drift poll the ADR-0021 §5 calls for. Track Sprint 0.13 + Sprint 2.2 in `docs/01-business/community-platform-roadmap.md` §7. **Gated on ADR-0021 Acceptance** (currently Proposed).
