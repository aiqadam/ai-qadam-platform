...
- ⛔ [Archived: first production deploy via Coolify](infrastructure/runbooks/_archive/coolify-app-stacks.md) — superseded by [ADR-0040](../adr/0040-deployment-target-pro-data-tech.md)
- ⛔ [Archived: bootstrapping Coolify on a fresh VM](infrastructure/runbooks/_archive/coolify-bootstrap.md) — superseded by [ADR-0040](../adr/0040-deployment-target-pro-data-tech.md)
