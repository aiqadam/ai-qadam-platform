...
4. **Block catalogue** at [`blocks.md`](../architecture/blocks.md) — the L3 doc
   you're committing as part of PR-0a.
5. **Wiring map** at [`wiring-map.md`](../architecture/wiring-map.md) — the cabinet
   ↔ aggregate registry you're committing as part of PR-0a.
6. **Parity matrix** at [`parity-matrix.md`](../../03-requirements/parity-matrix.md) —
...
| `docs/04-development/frontend/web-migration-plan.md` | ALREADY EXISTS | The phased plan |
| `docs/04-development/architecture/blocks.md` | ALREADY EXISTS | L3 catalogue (empty rows) |
| `docs/04-development/architecture/wiring-map.md` | ALREADY EXISTS | Data-flow registry |
| `docs/03-requirements/parity-matrix.md` | ALREADY EXISTS | Cutover gate |
...
| `docs/05-other/agent-prompts.md` | EDIT | Add new §0.2 "Block-First Pre-Flight Gate 0" referencing this kickoff doc |
...
// Lock 4: edits to blocks/* require edits to docs/04-development/architecture/blocks.md
const blockEdits = touched.filter(f => f.match(/apps\/web-next\/src\/blocks\//));
const catalogueEdited = touched.includes('docs/04-development/architecture/blocks.md');
...
- [ ] If I added a block: I added a Storybook story + updated `docs/04-development/architecture/blocks.md`
...
2. Read [`docs/04-development/architecture/blocks.md`](./architecture/blocks.md)
