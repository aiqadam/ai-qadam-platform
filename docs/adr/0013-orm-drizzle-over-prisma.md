...
1. **Conflict with [STANDARDS.md §VI Migrations](../04-development/standards.md).** The standard requires reversible migrations ("every up has a down"). Prisma's migration tool is forward-only by design. The conflict had to be resolved by either softening the rule or switching tooling.
...
- **`drizzle-kit` supports reversible migrations.** Resolves the conflict with [STANDARDS.md §VI](../04-development/standards.md) without requiring a rule change.
...
- ✅ [STANDARDS.md §VI](../04-development/standards.md) reversible-migration rule survives unchanged — `drizzle-kit` honors it natively.
...
## References
- [STANDARDS.md §VI Migrations](../04-development/standards.md) — the rule that drove the resolution.
