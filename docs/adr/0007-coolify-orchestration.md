...
- Self-hosted, open-source per [PROJECT.md](../../.claude/PROJECT.md) constraints
...
- **Open source, self-hosted, MIT-license-compatible.** Aligns with [PROJECT.md §Constraints](../../.claude/PROJECT.md).
...
- 📝 **First-run admin port (8000) is initially world-reachable** if you don't lock down immediately — caught by us on 2026-05-14, fixed structurally per [ADR-0008](0008-docker-port-publishing-policy.md). Bootstrap procedure documented in [docs/runbooks/coolify-bootstrap.md](../runbooks/coolify-bootstrap.md).
...
- [docs/runbooks/coolify-bootstrap.md](../runbooks/coolify-bootstrap.md) — bootstrap procedure
