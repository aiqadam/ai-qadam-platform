...
F-S1.1a publication broadcast · F-S1.1b speaker_added flow · F-S1.1c post-event cron · F-S1.2+1.3 CSAT capture + operator surface (bundled) · F-S1.4 pre-event reminders · F-S1.5 member matching · ~~F-S1.6 lead capture~~ ✅ shipped 2026-05-21 (capture + verify + convert; F-S1.6b nurture cron flows still pending).
