...
**Pre-reading:** [event-publication-broadcast.md](./event-publication-broadcast.md), [event-pre-event-reminders.md](./event-pre-event-reminders.md), [ux-and-content-guidelines.md §13](../ux-and-content-guidelines.md#13-notification-copy-library), [ADR-0033](../adr/0033-community-member-graph.md).
