...
**Pre-reading:**
- [`docs/plans/f-ops1-snapshot-restore-ui.md`](../plans/f-ops1-snapshot-restore-ui.md) — the architecture decision
- [`docs/runbooks/restic-backups.md`](./restic-backups.md) — the underlying restic setup
...
- [F-OPS1 plan](../plans/f-ops1-snapshot-restore-ui.md) — design rationale
- [restic-backups.md](./restic-backups.md) — the underlying backup architecture
- [break-glass.md](./break-glass.md) — when SSO is also broken
