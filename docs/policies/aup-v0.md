...
Your behavior as an operator sets the tone. The [community-conduct playbook](../operator-playbook/community-conduct.md) covers how operators handle incidents involving members. As an operator, you are also bound by the same conduct expectations you enforce.
...
If your role is `country_lead_*`: compensation arrangements are currently TBD per [business-process-gaps.md G-1](../business-process-gaps.md). The operating expectation through 2027 is volunteer-class; comp model will be communicated separately if and when it changes. By accepting this invite as a country-lead, you acknowledge that compensation is not contractually established at this time.
