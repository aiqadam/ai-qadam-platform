...
| **3.6 — Cabinet #5: Member self-service** at `/me/profile` | Members themselves. Manage own profile, per-purpose consents (events/marketing/research/recruiting/sponsor_share/content/paid_premium), interests, employment history, visibility. Powers the graph by giving members agency over what's in it; activates the GDPR posture from day one. | 1 vertical PR (~1 day) |
