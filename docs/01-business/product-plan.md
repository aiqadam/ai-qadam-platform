...
> **Companion to**: [`community-platform-roadmap.md`](community-platform-roadmap.md) (sprint-level tactical plan), [`marketing-and-pr-playbook.md`](../02-business-processes/marketing-and-pr-playbook.md) (channel strategy + funnel), [`ux-and-content-guidelines.md`](../04-development/design-system/ux-and-content-guidelines.md) (presentation), [`agent-prompts.md`](../05-other/agent-prompts.md) (execution).
>
...
| **LinkedIn** | Manual solo (Viktor) | + scheduled posts (Buffer-style) via marketing dashboard; founder-led content (Binali + Viktor distinct voices per [playbook §13](../02-business-processes/marketing-and-pr-playbook.md)) | + speaker amplification kit auto-posts; sponsor co-marketing posts |
...
**Next 6 months (per [roadmap §7](community-platform-roadmap.md) + [agent-prompts.md §4](../05-other/agent-prompts.md))**:
...
Today's tier ladder (per [marketing playbook §3.5](../02-business-processes/marketing-and-pr-playbook.md)): Community partner $0 / Bronze $500–1.5K / Silver $1.5K–4K / Gold $4K–10K / Platinum custom.
...
### 10.2 AARRR funnel (per [marketing playbook §3](../02-business-processes/marketing-and-pr-playbook.md))
...
- [`ux-and-content-guidelines.md`](../04-development/design-system/ux-and-content-guidelines.md) — voice + personas + form structures + onboarding scripts
- [`marketing-and-pr-playbook.md`](../02-business-processes/marketing-and-pr-playbook.md) — channel strategy + AARRR funnel + sponsor tiers + UTM
- [`agent-prompts.md`](../05-other/agent-prompts.md) — vertical-feature backlog + kick-off template
