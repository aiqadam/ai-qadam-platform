...
// the event's country.
//
// Port of apps/web/src/lib/og-template.tsx (FR-EVT-004 gap-closure,
// wf-20260730-feat-155) — same render function, importing web-next's
// ApiEvent/EventSpeaker from lib/types instead of v1's lib/api.

import React from 'react';
import type { ApiEvent, EventSpeaker } from './types';
