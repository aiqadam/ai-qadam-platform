...
//
// TTFs come from the `geist` npm package (apps/web-next/node_modules/geist/
// dist/fonts/geist-sans/). Satori 0.10+ accepts TTF/OTF/WOFF — not
// WOFF2 — so we use the TTF variants.
//
// Verbatim port of apps/web/src/lib/og-fonts.ts (FR-EVT-004 gap-closure,
// wf-20260730-feat-155) — no web-next-specific changes needed.
